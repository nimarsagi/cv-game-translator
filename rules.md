...
**Requirements.** Go through the job post line by line. A requirement is anything the job asks the person to have or do: must-haves, nice-to-haves and duties. The company intro, benefits, salary and how to apply are not requirements. Nor is what the job offers the person: training, workshops or "opportunities" to take on extra tasks. Read who does what: attending supervision is a duty, and "Intensive training in CBT" is an offer. Leave offers out of the map; the check sheet lists them as not a requirement.
